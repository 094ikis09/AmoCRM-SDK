...
use AmoCRM\Entities\AbstractEntity;
...
class TaskModel extends AbstractModel
{
     ...
     * @param int|AbstractEntity|null $element_id
    ...
    )
    {
        ...
        if ($element_id != null) {
            if (!($element_id instanceof AbstractEntity)) {
                if (!is_numeric($element_id)) {
                    throw new AmoCRMException('Передаваемая переменная не является числом или типом AbstractEntity');
                }
     ...
     *
     * @param int|AbstractEntity $element
     * @param int|null $limit_rows
     * @param int|null $limit_offset
     * @return TaskEntity[]
     * @throws AmoCRMException
