...
namespace AmoCRM\Models\Pipeline;
...
class PipelineModel extends BaseModel
{
    ...
    public function getPipelinesByName($pipelineName)
    {
        ...
        foreach ($res['_embedded']['items'] as $pipeline) {
            ...
            if($ePipeline->getName() === $pipelineName){
                $temp[] = $ePipeline;
            }
        }
        return $temp;
    ...
    public function deletePipelines($pipelines)
    {
        ...
        $this->client->call('/private/api/v2/json/pipelines/delete', array(), array('request' => array('id' => $temp)));
    }
    ...
    public function addPipelines($pipelines)
    {
        ...
        $this->client->call('/private/api/v2/json/pipelines/set', array(), $aPipelines);
    }
